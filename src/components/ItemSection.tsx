...
export function ItemSection () {
  const items = Array.from({ length: 12 }, (_, index) => ({
    image: `https://via.placeholder.com/300?text=Item+${index + 1}`,
    title: `Item ${index + 1}`,
